...
export default function GitHubCard({
    ...
    prs,
    commits,
    avatarUrl = "http://avatars.githubusercontent.com/u/61729454?v=4",
    showConnect = true
}: GitHubCardProps & { showConnect?: boolean }) {
    return (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="text-center p-3 bg-muted rounded-lg">
                                <div className="flex items-center justify-center gap-1 mb-1">
                                    ...
                                    <span className="text-2xl font-bold text-foreground">{prs}</span>
                                </div>
                                <p className="text-sm text-muted-foreground">PR lar</p>
                            </div>
                            <div className="text-center p-3 bg-muted rounded-lg">
                                <div className="flex items-center justify-center gap-1 mb-1">
                                    <span className="text-lg">💻</span>
                                    <span className="text-2xl font-bold text-foreground">{commits}</span>
                                </div>
                                <p className="text-sm text-muted-foreground">Commitlar</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
