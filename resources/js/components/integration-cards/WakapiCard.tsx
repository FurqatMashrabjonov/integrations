                            ...
                            <div className="flex items-center gap-2 min-w-0">
                                {profile.photo && (
                                    <img
                                        ...
                                        loading="lazy"
                                        onError={(e) => {
                                            e.currentTarget.src = 'https://via.placeholder.com/24?text=W';
                                        }}
                                    />
                                )}
                    ...
                    <CardContent className="pt-0">
                        {isConnected && stats ? (
                            <div className="grid grid-cols-1 gap-2">
                                <div className="text-center p-1.5 bg-muted rounded-lg">
                                    <div className="flex items-center justify-center gap-1 mb-0.5">
                                        ...
                                        <span className="text-sm font-bold text-foreground">{Math.floor(displayStats.codingTime / 3600)}h {Math.floor((displayStats.codingTime % 3600) / 60)}m</span>
                                    </div>
                                ...
                                {/*        <span className="text-sm font-bold text-foreground">{displayStats.languagesCount}</span>*/}
                                {/*    </div>*/}
                            ...
                            <div className="flex flex-col items-center justify-center py-4">
                                <div className="w-10 h-10 bg-muted rounded-full flex items-center justify-center mb-2 opacity-50">
